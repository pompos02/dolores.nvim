...
local function set_highlights()
    ...
    local default_highlights = {
        ...
        Conceal = { bg = "NONE" },
        CurSearch = { fg = palette.c11, bg = palette.c8, bold = true },
        Cursor = { fg = "NONE" },
        ...
        Visual = { bg = palette.visual, bold = true, blend = 30 },
        ...
        Comment = { fg = palette.c9, italic = styles.italic, bold = styles.bold },
        ...
        Keyword = { fg = palette.c7, bold = styles.bold },
        ...
        LspReferenceRead = { bold = styles.bold },
        LspReferenceText = { bold = styles.bold },
        ...
        xmlAttrib = { fg = palette.c13 },
        xmlCdata = { link = "String" },
        xmlCdataCdata = { fg = palette.c7, bold = styles.bold },
        xmlCdataEnd = { fg = palette.c6 },
        xmlCdataStart = { fg = palette.c6 },
        xmlComment = { link = "Comment" },
        xmlCommentEnd = { link = "Comment" },
        xmlCommentPart = { link = "Comment" },
        xmlCommentStart = { link = "Comment" },
        xmlDocType = { fg = palette.text },
        xmlDocTypeDecl = { fg = palette.c6 },
        xmlDocTypeKeyword = { link = "Keyword" },
        xmlEndTag = { fg = palette.c6 },
        xmlEntity = { link = "Special" },
        xmlEntityPunct = { fg = palette.c6 },
        xmlEqual = { fg = palette.text },
        xmlError = { link = "Error" },
        xmlInlineDTD = { fg = palette.text },
        xmlNamespace = { fg = palette.c13 },
        xmlProcessing = { fg = palette.c7, bold = styles.bold },
        xmlProcessingDelim = { fg = palette.c6 },
        xmlString = { link = "String" },
        xmlTag = { fg = palette.c6 },
        xmlTagName = { fg = palette.c12 },
        xmlTodo = { link = "Todo" },

        makeBString = { link = "Function" },
        makeCmdNextLine = { link = "makeSpecial" },
        makeCommandError = { link = "Error" },
        makeCommands = { fg = palette.c10 },
        makeComment = { link = "Comment" },
        makeConfig = { fg = palette.c13 },
        makeDefine = { fg = palette.text },
        makeDString = { link = "String" },
        makeError = { link = "Error" },
        makeEscapedChar = { link = "SpecialChar" },
        makeExport = { link = "makeStatement" },
        makeIdent = { fg = palette.c13 },
        makeImplicit = { link = "Function" },
        makeInclude = { link = "Include" },
        makeNextLine = { link = "makeSpecial" },
        makeOverride = { link = "makeStatement" },
        makePreCondit = { fg = palette.c7, bold = styles.bold },
        makeSString = { link = "String" },
        makeSpecial = { fg = palette.c14 },
        makeSpecTarget = { fg = palette.c14, bold = styles.bold },
        makeStatement = { fg = palette.c12, bold = styles.bold },
        makeTarget = { link = "Function" },
        makeTargetinDefine = { link = "Function" },
        makeTodo = { link = "Todo" },
        ...
        ["@comment.make"] = { link = "makeComment" },

        ["@character.special.make"] = { link = "makeSpecial" },
        ["@function.make"] = { link = "makeTarget" },
        ["@function.builtin.make"] = { link = "makeSpecTarget" },
        ["@operator.make"] = { fg = palette.c14 },
        ["@string.make"] = { link = "makeIdent" },
        ["@string.special.path.make"] = { fg = palette.c10 },
        ["@string.special.symbol.make"] = { link = "makeIdent" },
        ...
        ["@comment.xml"] = { link = "xmlComment" },
        ["@none.xml"] = { link = "Normal" },
        ["@tag.xml"] = { link = "xmlTagName" },
        ["@tag.attribute.xml"] = { link = "xmlAttrib" },
        ["@tag.delimiter.xml"] = { link = "xmlTag" },
        ["@attribute.xml"] = { link = "xmlAttrib" },
        ["@boolean.xml"] = { link = "Boolean" },
        ["@character.xml"] = { link = "Character" },
        ["@character.special.xml"] = { link = "SpecialChar" },
        ["@constant.xml"] = { link = "xmlEntity" },
        ["@constant.builtin.xml"] = { link = "xmlEntity" },
        ["@function.macro.xml"] = { link = "Macro" },
        ["@keyword.xml"] = { link = "xmlDocTypeKeyword" },
        ["@keyword.directive.xml"] = { link = "xmlProcessing" },
        ["@keyword.directive.define.xml"] = { link = "xmlDocTypeKeyword" },
        ["@keyword.modifier.xml"] = { link = "xmlDocTypeKeyword" },
        ["@label.xml"] = { link = "Label" },
        ["@markup.raw.xml"] = { link = "xmlCdata" },
        ["@module.xml"] = { link = "xmlCdataStart" },
        ["@number.xml"] = { link = "Number" },
        ["@operator.xml"] = { link = "xmlEqual" },
        ["@punctuation.bracket.xml"] = { link = "xmlTag" },
        ["@punctuation.delimiter.xml"] = { link = "xmlTag" },
        ["@string.xml"] = { link = "xmlString" },
        ["@string.special.xml"] = { link = "xmlString" },
        ["@string.special.url.xml"] = { link = "@string.special.url" },
        ["@type.builtin.xml"] = { link = "Type" },
        ["@type.definition.xml"] = { link = "Type" },
        ["@comment.dtd"] = { link = "xmlComment" },
        ["@tag.dtd"] = { link = "xmlTagName" },
        ["@tag.attribute.dtd"] = { link = "xmlAttrib" },
        ["@tag.delimiter.dtd"] = { link = "xmlTag" },
        ["@attribute.dtd"] = { link = "xmlAttrib" },
        ["@character.dtd"] = { link = "Character" },
        ["@character.special.dtd"] = { link = "SpecialChar" },
        ["@constant.dtd"] = { link = "xmlEntity" },
        ["@constant.builtin.dtd"] = { link = "xmlEntity" },
        ["@function.macro.dtd"] = { link = "Macro" },
        ["@keyword.dtd"] = { link = "xmlDocTypeKeyword" },
        ["@keyword.directive.dtd"] = { link = "xmlProcessing" },
        ["@keyword.directive.define.dtd"] = { link = "xmlDocTypeKeyword" },
        ["@keyword.import.dtd"] = { link = "Include" },
        ["@keyword.modifier.dtd"] = { link = "xmlDocTypeKeyword" },
        ["@label.dtd"] = { link = "Label" },
        ["@number.dtd"] = { link = "Number" },
        ["@operator.dtd"] = { link = "xmlEqual" },
        ["@punctuation.bracket.dtd"] = { link = "xmlTag" },
        ["@punctuation.delimiter.dtd"] = { link = "xmlTag" },
        ["@string.dtd"] = { link = "xmlString" },
        ["@string.special.dtd"] = { link = "xmlString" },
        ["@string.special.url.dtd"] = { link = "@string.special.url" },
        ["@type.builtin.dtd"] = { link = "Type" },
        ...
        ["@lsp.type.class.xml"] = { link = "xmlTagName" },
        ["@lsp.type.comment.xml"] = { link = "xmlComment" },
        ["@lsp.type.enumMember.xml"] = { link = "xmlEntity" },
        ["@lsp.type.keyword.xml"] = { link = "xmlDocTypeKeyword" },
        ["@lsp.type.macro.xml"] = { link = "Macro" },
        ["@lsp.type.namespace.xml"] = { link = "xmlNamespace" },
        ["@lsp.type.number.xml"] = { link = "Number" },
        ["@lsp.type.operator.xml"] = { link = "xmlEqual" },
        ["@lsp.type.parameter.xml"] = { link = "xmlAttrib" },
        ["@lsp.type.property.xml"] = { link = "xmlAttrib" },
        ["@lsp.type.string.xml"] = { link = "xmlString" },
        ["@lsp.type.type.xml"] = { link = "xmlTagName" },
        ["@lsp.type.variable.xml"] = { link = "Normal" },
        ...
        ["@lsp.typemod.property.declaration.xml"] = { link = "xmlAttrib" },
        ["@lsp.typemod.string.injected.xml"] = { link = "xmlString" },
        ["@lsp.typemod.variable.defaultLibrary.xml"] = { link = "xmlEntity" },
        ...
        BlinkCmpMenu = { fg = palette.c6, bg = palette.c3 },
        BlinkCmpMenuBorder = { fg = palette.c5, bg = palette.bg },
        BlinkCmpMenuSelection = { fg = "NONE", bg = palette.c17 },
        ...
        BlinkCmpKind = { fg = palette.c14, bg = "NONE" },
        ...
        BlinkCmpDefault = { fg = palette.c6 },
        BlinkCmpKindText = { fg = palette.text },
        BlinkCmpKindMethod = { fg = palette.c12 },
        BlinkCmpKindFunction = { fg = palette.c12 },
        BlinkCmpKindConstructor = { fg = palette.c12 },
        BlinkCmpKindField = { fg = palette.c12 },
        BlinkCmpKindVariable = { fg = palette.text },
        BlinkCmpKindClass = { fg = palette.c13 },
        BlinkCmpKindInterface = { fg = palette.c13 },
        BlinkCmpKindModule = { fg = palette.text },
        BlinkCmpKindProperty = { fg = palette.c12 },
        BlinkCmpKindUnit = { fg = palette.c14 },
        BlinkCmpKindValue = { fg = palette.c14 },
        BlinkCmpKindKeyword = { fg = palette.c7 },
        BlinkCmpKindSnippet = { fg = palette.c10 },
        BlinkCmpKindColor = { fg = palette.c14 },
        BlinkCmpKindFile = { fg = palette.c14 },
        BlinkCmpKindReference = { fg = palette.c16 },
        BlinkCmpKindFolder = { fg = palette.c14 },
        BlinkCmpKindEnum = { fg = palette.c13 },
        BlinkCmpKindEnumMember = { fg = palette.c14 },
        BlinkCmpKindConstant = { fg = palette.c14 },
        BlinkCmpKindStruct = { fg = palette.c13 },
        BlinkCmpKindEvent = { fg = palette.c11 },
        BlinkCmpKindOperator = { fg = palette.text },
        BlinkCmpKindTypeParameter = { fg = palette.c13 },
        BlinkCmpKindCodeium = { fg = palette.c16 },
        BlinkCmpKindCopilot = { fg = palette.c16 },
        BlinkCmpKindSupermaven = { fg = palette.c16 },
        BlinkCmpKindTabNine = { fg = palette.c16 },
