...
local function set_highlights()
	...
	local default_highlights = {
		...
		IncSearch = { fg = palette.bg, bg = palette.text },
		...
		Search = { fg = palette.bg, bg = palette.text },
		...
		StatusLine = { fg = palette.text, bg = palette.c3 },
		...
		Visual = { bg = palette.c12, blend = 10 },
		YankHighlight = { fg = "NONE", bg = palette.c14, blend = 10 },
