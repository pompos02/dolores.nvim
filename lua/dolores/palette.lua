...
local palette = {
    ...
    glykeria = {
        dark = {
            ...
            c9 = "#fe8019",   -- comments and folded text
        ...
        light = {
            ...
            c9 = "#d65d0e",   -- comments and folded text
    ...
    boy = {
        dark = {
            ...
            c11 = "#ff4545",  -- errors, exceptions, SpellBad, search labels
            c12 = "#ececec",  -- functions, methods, fields, visual selection, match highlights
